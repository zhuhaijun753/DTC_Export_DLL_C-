...
typedef enum _enumProtocol{
    ...
    eprotocol_PROTOCOL_RESERVE_76  = 76,
    eprotocol_PROTOCOL_RESERVE_77  = 77,
    eprotocol_PROTOCOL_RESERVE_78  = 78,
    eprotocol_PROTOCOL_RESERVE_79  = 79,
...
typedef enum _enumMonitortype{
    emonitortype_UNKNOWN   = 0,
    emonitortype_AIR_Secondary_____air_____system_____monitoring  = 1,
    emonitortype_BPS_Boost_____Pressure_____System_____Monitor  = 2,
    emonitortype_CAT_Catalyst_____monitoring  = 3,
    emonitortype_CCM_Comprehensive_____component_____monitoring  = 4,
    emonitortype_DPF_PM_____Filter_____Monitor  = 5,
    emonitortype_ECT_Engine_____Coolant_____Temperature  = 6,
    emonitortype_EGR_EGR_____system_____monitoring  = 7,
    emonitortype_EGS_Exhaust_____Gas_____Sensor_____Monitor  = 8,
    emonitortype_EVA_Evaporative_____system_____monitoring  = 9,
    emonitortype_FUE_Fuel_____system_____monitoring  = 10,
    emonitortype_HCA_Heated_____catalyst_____monitoring  = 11,
    emonitortype_HCC_NMHC_____Monitor  = 12,
    emonitortype_HTR_Oxygen_____sensor_____heater_____monitoring  = 13,
    emonitortype_MIS_Misfire_____monitoring  = 14,
    emonitortype_NOx_NOx_____Adsorber_____Monitor  = 15,
    emonitortype_O2S_Oxygen_____sensor_____monitoring  = 16,
}enumMonitortype;
...
typedef enum _enumDtcstatuse{
    ...
    edtcstatuse_Type_Dtc_Status_Suzuki_1  = 26,
    edtcstatuse_Type_Dtc_Status_GM_0008  = 27,
    edtcstatuse_Type_Dtc_Status_GM_0009  = 28,
    edtcstatuse_Type_Dtc_Status_GM_00010  = 29,
    edtcstatuse_Type_Dtc_Status_Oem_1  = 30,
    edtcstatuse_Type_Dtc_Status_Oem_2  = 31,
    edtcstatuse_Type_Dtc_Status_Oem_3  = 32,
    edtcstatuse_Type_Dtc_Status_Oem_4  = 33,
    edtcstatuse_Type_Dtc_Status_Oem_5  = 34,
    edtcstatuse_Type_Dtc_Status_Oem_6  = 35,
    edtcstatuse_Type_Dtc_Status_Oem_7  = 36,
    edtcstatuse_Type_Dtc_Status_Oem_8  = 37,
    edtcstatuse_Type_Dtc_Status_Oem_9  = 38,
    edtcstatuse_Type_Dtc_Status_Oem_10  = 39,
    edtcstatuse_Type_Dtc_Status_Oem_11  = 40,
    edtcstatuse_Type_Dtc_Status_Oem_12  = 41,
    edtcstatuse_Type_Dtc_Status_Oem_13  = 42,
    edtcstatuse_Type_Dtc_Status_Oem_14  = 43,
    edtcstatuse_Type_Dtc_Status_Oem_15  = 44,
    edtcstatuse_Type_Dtc_Status_Oem_16  = 45,
    edtcstatuse_Type_Dtc_Status_Oem_17  = 46,
    edtcstatuse_Type_Dtc_Status_Oem_18  = 47,
    edtcstatuse_Type_Dtc_Status_Oem_19  = 48,
    edtcstatuse_Type_Dtc_Status_Oem_20  = 49,
    edtcstatuse_Type_Dtc_Status_Oem_21  = 50,
    edtcstatuse_Type_Dtc_Status_Oem_22  = 51,
    edtcstatuse_Type_Dtc_Status_Oem_23  = 52,
    edtcstatuse_Type_Dtc_Status_Oem_24  = 53,
    edtcstatuse_Type_Dtc_Status_Oem_25  = 54,
}enumDtcstatuse;
...
typedef enum _enumBuffername{
    ...
    ebuffername_BUFF_RESEVER_34  = 34,
    ebuffername_BUFF_RESEVER_35  = 35,
    ebuffername_BUFF_RESEVER_36  = 36,
    ...
    ebuffername_Failed  = 43,
    ebuffername_Failed_____Operation_____Cycle  = 44,
    ebuffername_Not_____Completed_____SC  = 45,
    ebuffername_Not_____Completed_____Operation_____Cycle  = 46,
    ebuffername_Warning_____Indicator  = 47,
    ebuffername_Provisional  = 48,
    ebuffername_NOT_____CONFIRMED  = 49,
}enumBuffername;
...
typedef enum _enumDtcdisplaytype{
    ...
    edtcdisplaytype_DTC_ASCII  = 33,
    edtcdisplaytype_DTC_TRUCK_J1708  = 34,
    edtcdisplaytype_DTC_TRUCK_J1939  = 35,
}enumDtcdisplaytype;
