...
#define ENUM_OTHER      0xFFFE
#define ENUM_MAX        0xFFFF
#define ENUM_UNKNOWN    0x0000

#define     eYear_OTHERS     ENUM_OTHER
#define     eYear_MAX        ENUM_MAX

#define     eManufacturer_MAX_65535     ENUM_MAX    
...
#define     eMFR_MAKE_OTHERS            ENUM_OTHER
#define     eMFR_MAKE_MAX               ENUM_MAX

#define     eMake_OTHERS     ENUM_OTHER
#define     eMake_MAX        ENUM_MAX

#define     eModel_OTHERS     ENUM_OTHER
#define     eModel_MAX        ENUM_MAX

#define     eTrim_OTHERS    ENUM_OTHER
#define     eTrim_MAX       ENUM_MAX

#define     eBodyCode_OTHERS     ENUM_OTHER
#define     eBodyCode_MAX        ENUM_MAX

#define     eEngine_OTHERS    ENUM_OTHER
#define     eEngine_MAX       ENUM_MAX
