...
#define SUPPORTED_TOOL_3100J    0
#define SUPPORT_TOOL_F_BASIC_MX 1
...
#define _SUPPORTED_DTC_DEF_SUBARU    1
...
#define _SUPPORTED_DTC_DEF_DAEWOO    1
...
#define _SUPPORTED_DTC_DEF_OPEL    1
...
#define SUBARU_use_bYear                       0
#define SUBARU_use_sManufacturer               1
#define SUBARU_use_sModel                      0
#define SUBARU_use_sSystem                     0
#define SUBARU_use_sSubSystem                  0
#define SUBARU_use_sProtocol                   0
...
__ADAPTER_DTC_Custom(Chrysler,chrysler,CHRYSLER,eTRUE),  //PreTest eFALSE-->eTRUE
...
__ADAPTER_DTC(Subaru,subaru,SUBARU),
...
__ADAPTER_DTC(Opel,gm,GM),
__ADAPTER_DTC(Daewoo,gm,GM),
  {
