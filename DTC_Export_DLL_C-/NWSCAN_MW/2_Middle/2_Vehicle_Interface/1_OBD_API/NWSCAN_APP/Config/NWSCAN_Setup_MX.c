...
#include "LIB\PlatFormType.h"
#include "LIB\SYS_Utility.h"
#include "LIB\VDM_Adapter.h"
#include "NWSCAN_Setup_MX.h"
...
const structNWScanYmmeUsing strtNWScanYmmeUsing[] =
		{
						...
						YMME_NWSCAN_PROFILE_MAP(VAG,emake_Audi ,eTRUE , eTRUE, eTRUE , eFALSE, eFALSE, eFALSE, eFALSE, eFALSE, eFALSE),
                                                YMME_NWSCAN_PROFILE_MAP(VAG,emake_Seat ,eTRUE , eTRUE, eTRUE , eFALSE, eFALSE, eFALSE, eFALSE, eFALSE, eFALSE),
						...
						YMME_NWSCAN_PROFILE_MAP(Subaru,emake_Subaru ,eTRUE , eTRUE, eTRUE , eFALSE , eFALSE, eFALSE, eFALSE, eFALSE, eFALSE),
#endif
				/*
