...
#define VERSION_NWSCAN_LIB_ 	"NWSCAN V01.00.31"
#endif
...
typedef struct _structListDTCType
{
  ...
  uint8             bDTCIndex;
  uint8             bSeverity;/*Valid data in range >0 & <0xFF*/
  uint8             bReseve[BYTE_RESERVE];
}structListDTCType;
#pragma pack()
...
/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name: enumbool gf_VDM_NWSCAN_OBD1_GetListSystem_Profiles(enumManufacturer eManufacture,
		structNwSSystemUI *p_strtSystemUI,enumbool IsProfileID)
 *Input        :
 *Output       :
 *Description  :
 *return list system
 *if IsProfileID = eFALSE : get list system
 *if IsProfileID = eTRUE : Get List profile id
 *Historical   :
 *     1. Creation Lap Dang Apr 7, 2016  11:53:41 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
enumbool gf_VDM_NWSCAN_OBD1_GetListSystem_Profiles(enumManufacturer eManufacture,
		structNwSSystemUI *p_strtSystemUI,enumbool IsProfileID);
/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name: enumSystem gf_VDM_NWSCAN_OBD1_MsgIDToSystem(enumManufacturer eManufacture,enumMessageIds eMsgID)
 *Input        :
 *Output       :
 *Description  :
 *mapping message id to system
 *
 *
 *Historical   :
 *     1. Creation Lap Dang Apr 7, 2016  11:49:18 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
enumSystem gf_VDM_NWSCAN_OBD1_MsgIDToSystem(enumManufacturer eManufacture,
...
/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name: enumNWS_Market gf_VDM_NWSCAN_GetMarket(void)
 *Input        :
 *Output       :
 *Description  :
 *Get Market of NWSCAN LIB
 *
 *
 *Historical   :
 *     1. Creation Lap Dang  11:26:33 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
enumNWS_Market gf_VDM_NWSCAN_GetMarket(void);

/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name: gf_VDM_Dtc_GetDTCTypeList
 *Input        : structDtcParser *pstrtDtcParser,
 uint8 *pOutBuffName,
 uint16 sSizeStringOut
 *Output       :
 *Description  :
 -------------------------------------------------------------------------------*/
enumbool gf_VDM_Dtc_GetDTCInfo(structOemProfile *pstrtOemProfile, uint8 bIdxDtc,
		structListDTCType *pstrtListDTCType);

/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name: void gf_NWSCAN_UseManufactureOnly_Set(enumbool blstate)
 *Input        :
 *Output       :
 *Description  :
 *skip all field in ymme , just care only manufacture
 *
 *
 *Historical   :
 *     1. Creation Lap Dang Feb 16, 2016  10:08:45 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
void gf_NWSCAN_UseManufactureOnly_Set(enumbool blstate);
