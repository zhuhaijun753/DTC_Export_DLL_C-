...
#ifndef VERSION_PROTOCOL_LIB_
#define VERSION_PROTOCOL_LIB_ 	"OBD API V01.00.38"
#endif
...
/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name: structVehicleProfile*gf_VDM_GetVehicleProfile(void)
 *Input        :
 *Output       :
 *Description  :
 *use to get global variable vehicle link profile
 *
 *
 *Historical   :
 *     1. Creation Lap Dang  10:43:36 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
structVehicleProfile*gf_VDM_GetVehicleProfile(void);
 ...
 *Description  :
 *use to get variable link profile
 *
 *
 *Historical   :
...
/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name: void gf_VDM_Dtc_RegisterFuncCheckDtc(pfunc_IsValidDtc pf_IsValidDtc)
 *Input        :
 *Output       :
 *Description  :
 *set null if all dtc is valid even with dtc 00
 *
 *
 *Historical   :
 *     1. Creation Lap Dang Apr 20, 2016  10:13:22 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
void gf_VDM_Dtc_RegisterFuncCheckDtc(pfunc_IsValidDtc pf_IsValidDtc);

/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name: void gf_VDM_OemProfileDtcSetOffSetDtcFrame(structOemProfile * p_strtOemProfile,uint8 bOffset)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation Lap Dang Apr 26, 2016  10:10:20 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
void gf_VDM_OemProfileDtcSetOffSetDtcFrame(structOemProfile * p_strtOemProfile,uint8 bOffset);

/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name: uint8 gf_VDM_OemProfileDtcGetOffSetDtcFrame(structOemProfile * p_strtOemProfile)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation Lap Dang Apr 26, 2016  11:25:00 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
uint8 gf_VDM_OemProfileDtcGetOffSetDtcFrame(structOemProfile * p_strtOemProfile);
#endif
