...
typedef struct _structJ1850Frame
{
    ...
    uint8 bLen;//updated 20 APril 2016 to resolve issue CRC from ECU is 00
} structJ1850Frame;
...
/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name: uint8 gf_VBI_GetOffSetByte(structLinkProfile * p_strtLinkProfile)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation Lap Dang  9:31:36 AM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
uint8 gf_VBI_GetOffSetByte(structLinkProfile * p_strtLinkProfile);
/*------------------------------------------------------------------------------
 *Engineer     : Lap Dang
 *Function name:uint8 gf_VBI_OEM_SID_OffSet(uint8 bSID,uint8 * pDataReq,structLinkProfile * p_strtLinkProfile)
 *Input        :
 *Output       :
 *Description  :
 *
 ...
 *
 *Historical   :
 *     1. Creation Lap Dang Mar 17, 2016  1:27:39 PM
 *
 *
 *
 *
 -------------------------------------------------------------------------------*/
uint8 gf_VBI_OEM_SID_OffSet(uint8 bSID,uint8 * pDataReq,structLinkProfile * p_strtLinkProfile);
