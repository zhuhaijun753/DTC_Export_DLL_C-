...
#include "2_Middle\5_Communication\1_Usb\2_Core\Libraries\STM32_USB_Device_Library\Core\inc\usbd_def.h"
...
#if 1
uint8_t USBD_MSC_CfgDesc[MSC_HID_COMPOLap DangE_CFG_LEN];
#else
...
#if 1
__ALIGN_BEGIN uint8_t USBD_MSC_CfgDesc[MSC_HID_COMPOLap DangE_CFG_LEN] __ALIGN_END =
{

  USB_LEN_CFG_DESC,   /* bLength: Configuation Descriptor size */
  USB_DESC_TYPE_CONFIGURATION,   /* bDescriptorType: Configuration */
  MSC_HID_COMPOLap DangE_CFG_LEN,
  0x00,
  ...
  USB_MSC_IF_NUM,//0x00,   /* bInterfaceNumber: Number of Interface */
  0x00,   /* bAlternateSetting: Alternate setting */
  0x02,   /* bNumEndpoints*/
  0x08,   /* bInterfaceClass: MSC Class */
  0x06,   /* bInterfaceSubClass : SCSI transparent*/
  0x50,   /* nInterfaceProtocol */
  USBD_IDX_MSC_INTERFACE_STR,//0x05,          /* iInterface: */
  ...
  /* 09 */
  USB_LEN_IF_DESC,//0x09,         /*bLength: Interface Descriptor size*/
  USB_INTERFACE_DESCRIPTOR_TYPE,/*bDescriptorType: Interface descriptor type*/
  USB_HID_IF_NUM,//0x00,         /*bInterfaceNumber: Number of Interface*/
  0x00,         /*bAlternateSetting: Alternate setting*/
  0x01,         /*bNumEndpoints*/
  0x03,         /*bInterfaceClass: HID*/
  0x00,         /*bInterfaceSubClass : 1=BOOT, 0=no boot*/
  0x00,         /*nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse*/
  USBD_IDX_HID_INTERFACE_STR,//0,            /*iInterface: Index of string descriptor*/
