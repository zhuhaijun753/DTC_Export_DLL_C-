...
#ifndef __GUIMENUFORM_H__
#define __GUIMENUFORM_H__
...
*                                 PROTOTYPES
==============================================================================*/
void GUI_MenuFormStringInit(GUI_MENU_FORM* p_strtMenuFrm,
                            const void* strTitle,
...
void GUI_MenuFormDispInit(GUI_MENU_FORM* p_strtMenuFrm,
                          uint8 bNumberItem,
                          uint8 bNumDispCol,
...
void GUI_MenuFormDisplay(GUI_MENU_FORM* p_strtMenuFrm, SCR_DISP_TYPE eDispType);
...
void GUI_MenuSrollNextPage_New(GUI_MENU_FORM* p_strtMenuFrm);
