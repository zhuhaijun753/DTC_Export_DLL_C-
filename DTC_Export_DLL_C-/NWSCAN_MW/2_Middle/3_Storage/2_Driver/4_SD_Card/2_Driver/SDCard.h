...
SD_Error SD_WriteMultiBlocks(const uint8_t *writebuff, uint32_t WriteAddr, uint16_t BlockSize, uint32_t NumberOfBlocks);
...
extern SD_Error eDiskAccessStatus;
extern SD_Error eSDMountStatus;
#ifdef __cplusplus
}
#endif
